...
const SECTION_CONFIG: Record<string, { title: string; icon: string; color: string; data: Movie[] }> = {
  ...
  trending: { title: "Trending Now", icon: "flame", color: Colors.secondary, data: TRENDING },
  all: { title: "All Movies", icon: "film", color: Colors.primary, data: ALL_MOVIES },
};
...
export default function SeeAllScreen() {
  ...
  const sectionType = (params.section as string) || "all";

  const [searchQuery, setSearchQuery] = useState("");
  const [selectedGenre, setSelectedGenre] = useState<string | null>(null);

  const config = SECTION_CONFIG[sectionType] || SECTION_CONFIG.all;
